            ...
            <div className="col-lg-8 col-md-8">
              <div className="blog__details__content">
                <div className="blog__details__item">
                  <img
                    src="img/blog/details/xblog-details.jpg.pagespeed.ic.Eftje3CO1E.jpg"
                    alt=""
                  />
                ...
                <div className="blog__details__comment">
                  ...
                  <div className="blog__comment__item">
                    <div className="blog__comment__item__pic">
                      <img
                        src="img/blog/details/xcomment-1.jpg.pagespeed.ic.JfRVi2phHq.jpg"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="blog__comment__item blog__comment__item--reply">
                    <div className="blog__comment__item__pic">
                      <img
                        src="img/blog/details/xcomment-2.jpg.pagespeed.ic.NsFtWkF9gG.jpg"
                        alt=""
                      />
                    </div>
                    <div className="blog__comment__item__text">
                  ...
                  <div className="blog__comment__item">
                    <div className="blog__comment__item__pic">
                      <img
                        src="img/blog/details/xcomment-3.jpg.pagespeed.ic.TYd3zo2H8y.jpg"
                        alt=""
                      />
                    </div>
                    <div className="blog__comment__item__text">
                ...
                <div className="blog__sidebar__item">
                  ...
                  <a href="#" className="blog__feature__item">
                    <div className="blog__feature__item__pic">
                      <img
                        src="img/blog/sidebar/xfp-1.jpg.pagespeed.ic.Y1svk0Dcyu.jpg"
                        alt=""
                      />
                    </div>
                  ...
                  <a href="#" className="blog__feature__item">
                    <div className="blog__feature__item__pic">
                      <img
                        src="img/blog/sidebar/xfp-2.jpg.pagespeed.ic.sKqtnWRfn4.jpg"
                        alt=""
                      />
                    </div>
                    <div className="blog__feature__item__text">
                  ...
                  <a href="#" className="blog__feature__item">
                    <div className="blog__feature__item__pic">
                      <img
                        src="img/blog/sidebar/xfp-3.jpg.pagespeed.ic.IDUOHseGHz.jpg"
                        alt=""
                      />
                    </div>
                    <div className="blog__feature__item__text">
