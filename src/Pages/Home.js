                ...
                <div className="trend__content">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xht-1.jpg.pagespeed.ic.jRsl05-jGq.jpg"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xht-2.jpg.pagespeed.ic.MBYmEJ2Erh.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xht-3.jpg.pagespeed.ic.AFuVIGuv0U.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
              ...
              <div className="col-lg-4 col-md-4 col-sm-6">
                <div className="trend__content">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xbs-1.jpg.pagespeed.ic.lXhtNSXv0A.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xbs-2.jpg.pagespeed.ic.6YF5Q22-Ix.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xbs-3.jpg.pagespeed.ic.nNZ45KjrMi.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
              ...
              <div className="col-lg-4 col-md-4 col-sm-6">
                <div className="trend__content">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xf-1.jpg.pagespeed.ic.LwEIHvJYLu.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xf-2.jpg.pagespeed.ic.gOI6M0zzrL.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
                  ...
                  <div className="trend__item">
                    <div className="trend__item__pic">
                      <img
                        src="img/trend/xf-3.jpg.pagespeed.ic.5CGI-NcGYq.jpg"
                        alt=""
                      />
                    </div>
                    <div className="trend__item__text">
            ...
            <div className="row">
              <div className="col-lg-6 p-0">
                <div className="discount__pic">
                  <img
                    src="img/xdiscount.jpg.pagespeed.ic.pxZfPTwRzy.jpg"
                    alt=""
                  />
                </div>
              </div>
