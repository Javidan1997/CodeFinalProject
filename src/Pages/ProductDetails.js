              ...
              <div className="product__details__pic">
                <div className="product__details__pic__left product__thumb nice-scroll">
                  <a className="pt active" href="#product-1">
                    <img
                      src="img/product/details/xthumb-1.jpg.pagespeed.ic.dhgum41cuw.jpg"
                      alt=""
                    />
                  </a>
                  <a className="pt" href="#product-2">
                    <img
                      src="img/product/details/xthumb-2.jpg.pagespeed.ic.YtxSQ5id2I.jpg"
                      alt=""
                    />
                  </a>
                  <a className="pt" href="#product-3">
                    <img
                      src="img/product/details/xthumb-3.jpg.pagespeed.ic.P_OD8uejqv.jpg"
                      alt=""
                    />
                  </a>
                  <a className="pt" href="#product-4">
                    <img
                      src="img/product/details/xthumb-4.jpg.pagespeed.ic.d-ZL7FBcuy.jpg"
                      alt=""
                    />
                  </a>
                </div>
                <div className="product__details__slider__content">
                  <div className="product__details__pic__slider owl-carousel">
                    <img
                      ...
                      src="img/product/details/xproduct-1.jpg.pagespeed.ic.YOawdp1gFs.jpg"
                      alt=""
                    />
                    <img
                      data-hash="product-2"
                      className="product__big__img"
                      src="img/product/details/xproduct-3.jpg.pagespeed.ic.MpDTL5XHS1.jpg"
                      alt=""
                    />
                    <img
                      data-hash="product-3"
                      className="product__big__img"
                      src="img/product/details/xproduct-2.jpg.pagespeed.ic.CGvroNuz8d.jpg"
                      alt=""
                    />
                    <img
                      data-hash="product-4"
                      className="product__big__img"
                      src="img/product/details/xproduct-4.jpg.pagespeed.ic.vZjdajPGxW.jpg"
                      alt=""
                    />
                  </div>
                </div>
